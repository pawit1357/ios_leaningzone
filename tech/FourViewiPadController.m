...
//    [topic setFont:[UIFont fontWithName:@"Quark-Light" size:18]];
...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    //UIImage *image1_11 = [UIImage imageNamed:@"14.png"];
...
-(void)gameOver
{
    endView = [[endGameiPadViewController alloc] initWithNibName:@"endGameiPadViewController" bundle:nil];
