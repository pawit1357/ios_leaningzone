...
#import "MenuCell_iPad.h"

@interface subViewiPad ()

@end

@implementation subViewiPad
...
{
    static NSString *simpleTableIdentifier = @"MenuCell_iPad";
    
    MenuCell_iPad *cell = (MenuCell_iPad *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    if (cell == nil)
    {
...
{
    DetailsViewiPad *sView = [[DetailsViewiPad alloc] initWithNibName:@"DetailsViewiPad" bundle:nil];
