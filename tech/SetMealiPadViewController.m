...
@interface SetMealiPadViewController ()

@end

@implementation SetMealiPadViewController
...
{
    static NSString *simpleTableIdentifier = @"VideoCell_iPad";
